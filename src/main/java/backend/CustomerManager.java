...
public class CustomerManager {
	...
	/**
	 * Validates email address based on IETF RFC 6530
	 * @param email Email address string to be validated
	 ...
	 * @param conn The database conncection to use for customer managment.
	 */
	 ...
	 */
	public Customer findOrMake(String firstName, String lastName, String phoneNumber, String email, String address) throws IllegalArgumentException {
	 ...
	 */
	public Customer createCustomer(String firstName, String lastName, String phoneNumber, String email, String address) throws IllegalArgumentException {
		Customer customer = null;
		// Validate Email
	...
	/**
	 * Get iterable of all customers in database.
	 * @return Iterable of all customers in database
	 */
